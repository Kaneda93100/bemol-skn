...
path_bem    = p.Path('/home/arthur/Documents/GitHub/bemol-skn/DataBuilding/BEM_data_YAW_off.xlsx')
path_sven   = p.Path('/home/arthur/Documents/GitHub/bemol-skn/DataBuilding/results_yaw_15.0deg.csv')

print(f"\nDonnées BEM : {path_bem}\n")
print(f"\nDonnées SVEN : {path_sven}\n")
...
plt.suptitle(f"{path_bem.name} vs {path_sven.name}")
